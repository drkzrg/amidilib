...
CFLAGS += -m68000 -Wall -pedantic -Wl,--traditional-format -DDEBUG_FILE_OUTPUT -DDEBUG_CONSOLE_OUTPUT 
...
$(EXE): $(OBJECTS) 
	...
	$(CC) $(LDFLAGS) $(INCLUDES) $(OBJECTS) $(CFLAGS) amidi.o int_rout.o -o $@ -lgem 
